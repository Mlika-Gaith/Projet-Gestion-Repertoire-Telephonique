...
HWND recherche_indicatif_affichage_fenetre;
HWND hListView;
...
LRESULT CALLBACK RechercheIndicatifAffichageProcedure (HWND hwnd, UINT msg, WPARAM wp , LPARAM lp){
    ...
    case WM_SIZE:
        ...
        GetWindowRect(recherche_indicatif_affichage_fenetre, &MainRect);
    ...
    case WM_CLOSE:
        DestroyWindow(recherche_indicatif_affichage_fenetre);
        break;
    default:
...
void registerRechercheIndicatifAffichageFenetreClass(HINSTANCE hInstance){
    ...
    affichage.lpszClassName = L"AffichageRechercheIndicatif";
    affichage.lpfnWndProc = RechercheIndicatifAffichageProcedure;
...
HWND displayRechercheIndicatifAffichageFenetre (HWND hwnd, repertoire rt , char indicatif [35]){
    ...
    recherche_indicatif_affichage_fenetre = CreateWindowW(L"AffichageRechercheIndicatif",L" Contenu du Repertoire Telephonique ", WS_OVERLAPPEDWINDOW | WS_VISIBLE | WS_VSCROLL | WS_HSCROLL,
    ...
    hListView = CreateWindowEx(0, WC_LISTVIEW, 0, WS_CHILD |WS_VISIBLE | WS_BORDER | LVS_ALIGNLEFT | LVS_REPORT | LVS_EDITLABELS ,0,0,MainRect.right - MainRect.left,
                                     MainRect.bottom - MainRect.top,recherche_indicatif_affichage_fenetre,NULL, NULL, NULL);
    ...
    while (r2 != NULL){
        char ind [5];
        if (strcmp(strncpy(ind,r2->cont.numero,2),indicatif) == 0){
    ...
    return recherche_indicatif_affichage_fenetre;
